    ...
    if st.session_state['usercheck']==True:
        if st.session_state["st"]==True:
            ...
            if st.button("Confirm"):
                ...
                st.write(dx)
                sql = """INSERT INTO qst1 (Username, Nome, Cognome,Livello_sodisfazione, q1, q2,q3 ,q4 ,q5 , time) VALUES ('{}','{}','{}','{}','{}','{}','{}','{}','{}','{}')""".format("Username","Nome","Cognome", "Livello_sodisfazione", "q1", "q2", "q3", "q4", "q5", "time")
                cursor = conn.cursor()
                cursor.execute(sql)
